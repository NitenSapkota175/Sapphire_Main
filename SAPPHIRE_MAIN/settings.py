...
JAZZMIN_SETTINGS = {
    ...
    "site_logo": "static/images/SAPPHIRE_COMMOTRADE_FINAL_Logo_2",


        # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": "static/images/SAPPHIRE_COMMOTRADE_FINAL_Logo_2" ,
    ...
    "site_icon": "static/images/SAPPHIRE_COMMOTRADE_FINAL_Logo_2" ,
